...
CREATE TABLE [ExtraOderItems] (
    [Id] int NOT NULL IDENTITY,
    [Description] nvarchar(max) NULL,
    [Price] decimal(18,2) NOT NULL,
    [IdOrder] int NOT NULL,
    CONSTRAINT [PK_ExtraOderItems] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_ExtraOderItems_Orders_IdOrder] FOREIGN KEY ([IdOrder]) REFERENCES [Orders] ([Id]) ON DELETE NO ACTION
);
GO

CREATE INDEX [IX_ExtraOderItems_IdOrder] ON [ExtraOderItems] ([IdOrder]);
GO
...
VALUES (N'20210405162518_InitialMigration', N'5.0.4');
GO
